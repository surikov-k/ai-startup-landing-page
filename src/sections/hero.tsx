...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/*Start Ring 1*/}
      <div className="absolute left-1/2 top-1/2 size-[344px] -translate-x-1/2 -translate-y-1/2 rounded-full border opacity-15 md:size-[580px]">
      ...
      {/*Start Ring 2*/}
      <div className="absolute left-1/2 top-1/2 size-[444px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-white/20 md:size-[780px]"></div>
      {/*End Ring 2*/}

      {/*Start Ring 3*/}
      <div className="absolute left-1/2 top-1/2 size-[544px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-white opacity-20 md:size-[980px]">
      ...
      <div className="container relative mt-16">
        <h1 className="bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,0.5))] bg-clip-text text-center text-8xl font-semibold tracking-tighter text-transparent md:text-[168px] md:leading-none">
          AI SEO
        </h1>
        <p className="mt-5 text-center text-lg text-white/70 md:mx-auto md:max-w-xl md:text-xl">
